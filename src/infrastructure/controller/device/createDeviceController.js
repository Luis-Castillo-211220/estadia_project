...
class CreateDeviceController {
    ...
    async run(req = Request, res = Response) {
        try {
            const { ip_address_id, owner_name, device_type, brand, model, serial, patrimony, user_id, mac_address, ubication, proxy, observations} = req.body
            // const { user_name } = req.params
            const createDevice = await this.createDeviceUseCase.run(ip_address_id, owner_name, device_type, brand, model, serial, patrimony, user_id, mac_address, ubication, proxy, observations)
